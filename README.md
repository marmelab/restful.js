...
* `delete ( id [, headers, data ] )`: Delete a member in a collection. Returns a promise with the response.
...
* `delete ( [ headers, data ] )`: Delete a member. Returns a promise with the response.
